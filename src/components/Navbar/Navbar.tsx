...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-between">
      ...
      <ul className="backdrop-blur-md h-full lg:mt-3 lg:w-1/2 lg:justify-center hidden gap-x-9 text-white rounded bg-navigationBar/10 px-7 font-BarlowCondensed md:flex lg:bg-navigationBar/10">
        <li className="py-7">
          <NavLink
            className={(navData) =>
              navData.isActive
