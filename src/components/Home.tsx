...
const Home = () => {
  return (
    <section className="pb-4 mt-12 lg:mt-32 px-8 flex text-white flex-col items-center justify-center gap-y-4 lg:flex-row">
      <div className="lg:ml-24 text-center flex flex-col lg:items-start flex-1">
        ...
        <div className="flex justify-center lg:justify-start mx-auto lg:items-start">
          <p className="lg:text-start md:w-1/3 font-Barlow text-customblue mb-16 break-words">
